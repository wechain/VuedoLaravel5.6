        ...
        <div class="row control-group">
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} form-group col-xs-12 floating-label-form-group controls">
              <label for="email">邮箱地址</label>
                  ...
                  <input id="email" placeholder="邮箱地址 *" type="email" class="form-control" name="email" value="{{ old('email') }}">
        ...
        <div class="row control-group">
            <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }} form-group col-xs-12 floating-label-form-group controls">
              <label for="password-confirm">重复密码</label>
                  ...
                  <input id="password-confirm" placeholder="重复密码 *" type="password" class="form-control" name="password_confirmation">
